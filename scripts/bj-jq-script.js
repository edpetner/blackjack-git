$(function(){
  ...
  $('#stay').on('click',function(){
    while(totalScore(0) < 17){
      ...
      updateUI(0,true);
      setTimeout(function(){
          // empty function to kill 1 second between draws
      },1000);
    }
    winCheck();
  });
...
function updateUI(arg,dCheck){
  ...
  playerHand.forEach(function(c,i){
    target.append(createCard(Math.floor(c/13), (c%13)+1,target,i,dCheck).css({position: 'absolute', top: yAxis, left: 100+i*160}).prop('outerHTML'));
  });
